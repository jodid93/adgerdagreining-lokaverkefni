...
# Passa að öll samkennd námskeið gerist í sama prófstokki
# Lógíkin er að ef einhver námskeið eru samkennd (cidCommon[c1,c2] > 0)
# og þau eru í sama slotti (e) þá á ég að fá 0 því þá er 
# t.d. Slot[c1, 3] = 1 og Slot[c2, 3] = 1. Ef þau eru samkennd og ekki
# í sama slotti þá fæ ég Slot[c1, 8] = 1 og Slot[c2,8] = 0 sem þýðir
# að útkoman verður >0 og þar af leiðandi ólögleg. Ef námskeiðin
# eru ekki samkennd þá er cidCommon alltaf 0 og þar af leiðandi löglegt.
# Hef ekki hugmynd hvort að þetta virkar.
s.t. SameTime{c1 in CidExam, c2 in CidExam}: sum{e in ExamSlots} 
				cidCommon[c1,c2] * (Slot[c1, e] - Slot[c2, e) = 0; 
